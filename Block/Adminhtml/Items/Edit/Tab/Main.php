...
namespace Test\ShopByBrand\Block\Adminhtml\Items\Edit\Tab;
...
class Main extends Generic implements TabInterface
{
 ...
 /**
    ...
    public function __construct(
        ...
        \Test\ShopByBrand\Model\Status $status,
        array $data = []
    ) {
    ...
    {
        $model = $this->_coreRegistry->registry('current_Test_shopbybrand_items');
