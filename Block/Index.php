<?php
namespace Test\ShopByBrand\Block;
class Index extends \Magento\Framework\View\Element\Template
{
    ...
    public function __construct(
        \Magento\Framework\View\Element\Template\Context $context,
         \Test\ShopByBrand\Model\BrandFactory $brandFactory
    ) 
    {
    ...
    public function getBrands(){
		...
		$collection->addFieldToFilter('is_active' , \Test\ShopByBrand\Model\Status::STATUS_ENABLED);
...
// 		return $model->getOptions();
		...
		$collection = $this->_brandFactory->create()->getCollection();
		$collection->addFieldToFilter('is_active' , \Test\ShopByBrand\Model\Status::STATUS_ENABLED);
		$collection->addFieldToFilter('featured' , \Test\ShopByBrand\Model\Status::STATUS_ENABLED);
