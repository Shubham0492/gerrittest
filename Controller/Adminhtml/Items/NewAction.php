...
use Test\ShopByBrand\Model\Items;

class NewAction extends \Test\ShopByBrand\Controller\Adminhtml\Items
{
	/**
...
//         var_dump(get_class_methods($model));
		foreach($model->getOptions() as $option){
			...
			$item = $this->_objectManager->create('Test\ShopByBrand\Model\Items');
			if($option->getValue()){			
