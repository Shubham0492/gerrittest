...
class Save extends \Test\ShopByBrand\Controller\Adminhtml\Items
{
	...
	//             var_dump($data);die;
			...
			if(isset($data['logo']['value']) && strlen($data['logo']['value']) > 1)
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('Test_shopbybrand/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('Test_shopbybrand/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('Test_shopbybrand/*/new');
                }
                return;
            } catch (\Exception $e) {
                ...
                $this->_redirect('Test_shopbybrand/*/edit', ['id' => $this->getRequest()->getParam('id')]);
                return;
            }
        }
        $this->_redirect('Test_shopbybrand/*/');
